...
static const std::vector<COLOR24> STDColor = {	// 標準カラーデータ ( R,G,B,0  0-255 )
	...
	{ 252,  90,   4, 0 },	// 28:橙
	// mode 4
	{   4, 106,   4, 0 },	// 29:深緑(Set1)
	{  83, 242,  55, 0 },	// 30:緑
	{  30,  30,  30, 0 },	// 31:黒(Set2)
	{ 224, 255, 208, 0 },	// 32:白
	
	{ 146,  82,  13, 0 },	// 33:にじみ 赤(Set1)
	{  28, 202, 121, 0 },	// 34:にじみ 青(Set1)
	{ 120,  60,  95, 0 },	// 35:にじみ 桃(Set1)
	{  80, 190,  80, 0 },	// 36:にじみ 緑(Set1)
	
	{  81, 192,  14, 0 },	// 37:にじみ 明赤(Set1)
	{  69, 130,   9, 0 },	// 38:にじみ 暗赤(Set1)
	{  21, 221,  47, 0 },	// 39:にじみ 明青(Set1)
	{  14, 156,  50, 0 },	// 40:にじみ 暗青(Set1)
	
	{ 113, 210,  15, 0 },	// 41:にじみ 明桃(Set1)
	{  52, 132,  38, 0 },	// 42:にじみ 暗桃(Set1)
	{  70, 200,  60, 0 },	// 43:にじみ 明緑(Set1)
	{   4, 145,  47, 0 },	// 44:にじみ 暗緑(Set1)
	
	{ 255,  48,   0, 0 },	// 45:にじみ 赤(Set2)
	{  38, 201, 255, 0 },	// 46:にじみ 青(Set2)
	{ 255,  0,  236, 0 },	// 47:にじみ 桃(Set2)
	{  38, 255,  92, 0 },	// 48:にじみ 緑(Set2)
	
	{ 255, 140,  64, 0 },	// 49:にじみ 明赤(Set2)
	{ 150,  45,  00, 0 },	// 50:にじみ 暗赤(Set2)
	{ 119, 207, 255, 0 },	// 51:にじみ 明青(Set2)
	{  30,  80, 150, 0 },	// 52:にじみ 暗青(Set2)
	
	{ 255,  64, 131, 0 },	// 53:にじみ 明桃(Set2)
	{ 151,   0, 105, 0 },	// 54:にじみ 暗桃(Set2)
	{ 119, 255, 167, 0 },	// 55:にじみ 明緑(Set2)
	{  30, 151, 100, 0 },	// 56:にじみ 暗緑(Set2)
